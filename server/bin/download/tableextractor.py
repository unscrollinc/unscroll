#!/usr/bin/python
# -*- coding: utf-8 -*-
# Originally https://github.com/yuanxu-li/html-table-extractor/tree/master/html_table_extractor
        ...
        for row in self._table.find_all('tr'):
            ...
            for cell in row.children:
                if cell.name in ('td', 'th'):
                    ...
                    try:
                        self._insert(row_ind, col_ind, row_span, col_span, self._transformer(cell))
