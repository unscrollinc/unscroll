        ...
        return (
            <div class="Editor">
              <div class="About">
                ...
                <p>Paul Ford, <a href="mailto:ford@unscroll.com">ford@unscroll.com</a>. Also on twitter at @ftrain; my DMs are open. But for God's sake send an email instead of DMing unless you are just constitutionally incapable of using email.</p>
                ...
                <p>That's basically it, but it leads to a nice new way
                  of writing. Because the Events are searchable it's easy to
                ...
                <p>Because of The Magic of Hypertext you can easily make
                  ...
                  connected to events that inspired it.</p>
                ...
                <p>It gives you a superpower: The power to remember what
                  the hell you are talking about. If you don't need that
                  superpower, more power to you. But I personally 
                  need that superpower.</p>
                
                <h2>I don't get why you'd use this instead of [any other
                  one of thousands of software products].</h2>
		  ...
		  software is designed for writing processes that don't make
                ...
                <p>I've been coding and managing software projects for
                  years. I also used to be an editor at Harper's Magazine and I
		  once wrote an entire issue of Bloomberg
                  Businessweek about Code and won the national magazine
                  award for that. I've written for an awful lot of
                  magazines and it's gone pretty well, but I live in terror
		  of getting things wrong, like any journalist.</p>
                
                <p>I've been working on this thing for years and I have
                  the resources, connections, and capital to keep it
                  running.</p>

                <p>Anyway, I can keep this thing running just fine.</p>
                ...
                <p>At the same time I felt an urgent need to stay
                  ...
                  love my job, but I need to make things too. I love writing
		  and I love programming.</p>
		  ...
		  would need to get tens of thousands
                ...
                foundational philosophical challenges about the nature
                of truth in about five minutes.</p>

		<p>A community, should one form, will define the
                culture here, and the software would support the
                community's definition of accuracy.</p>

		<p>Even when you import really
                 well-regarded sources--museum collections, for
                 example--it's hard to know when something happened and often utterly
                  ...
                  midnight. Let's see what happens. This is because the problem I've found when writing about things that happened is almost always that
you put them too soon, not too late. So we err on the side of the last
possible moment and keep the original text of the date/time
around.</p>
                ...
                <p>Something would happen. Also I'd be able to use other
		   people's events and timelines to inform my own writing 
                   and thinking.</p>
