...
class About extends React.Component {
    ...
    render() {
        return (
		  ...
		  <p>It sees the worlds in terms of <i>Events</i>
   		    and <i>Notes</i>.</p>

  		  <p>You put <i>Events</i> into a <i>Timeline</i>.</p>

		  <p><i>Notes</i> are just what you think
		    about <i>Events</i>. Or random thoughts.</p>
    		  ...
    		  <p>You arrange <i>Notes</i> in <i>Notebooks</i>. Get
    		    ...
    		    essays, or book chapters, or blog posts.</p>
                  ...
                  <p>All easy enough, right? Events in Timelines,
                    ...
                    you are writing about as you are writing it, so
                    that you don't run your fool mouth without
                    pointing to your evidence. If you don't need that
                    superpower, more power to you. But I personally
                    need that superpower more every day.</p>

                  <h2>Who is it for?</h2>

                  <p>People who require accuracy.</p>

                  <p>(<i>Something something Fake News and the fact
                      that there are very few fact-checkers and editors,
                      and writers are more culturally and economically
                      vulnerable than ever and one good mistake away
                      from total career destruction.</i>)</p>
                  ...
                  <p>As a writer I'm best known for taking over an
                    ...
                    write <a href="https://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/">What
                      Is Code?</a>, which won awards and acclaim. I've
                    also written and published a novel and countless
                    personal essays and blog posts.</p>
                  ...
                  <p>As an entrepreneur, my friend Rich and I, and
                    many other wonderful people, founded a NYC-based
                    software development company
                    called <a href="https://postlight.com">Postlight</a>,
                    and today I'm the CEO there. We have around 50
                    employees and work on large, complex products and
                    platforms for our clients.</p>

                  <p>Unscroll is a side-project though, done at night
                    with a glass of wine with the kids in bed, when I
                    should be at the gym, and it pre-dates
                    Postlight. Postlight people are way too busy to
                    get roped into my quixotic late-night dreamquests,
                    plus they tend to have side projects of their
                    own.</p>
                  
                  <h2>Writers need fewer, not more, distractions.</h2>

                  <p>Sure! Although: Everyone says they want a
                    distraction-free writing environment but what they
                    really need are external pressure and deadlines. I
                    wrote this web CMS to help me in writing a book
                    about the web, which is now three years
                    late. Anyway. Let's see what happens.</p>
                  ...
                  <p>Right now this thing has one user. But let's say
                    you were the second. Who owns what?</p>
                  
                  <p>Mostly YOU, sometimes EVERYONE, never just
                    ME.</p>
	            ...
	            that.</p>
                  ...
                  <p>This is ultimately a thing designed to give back
                    to the commons so if something weird happens, like
                    anyone besides me uses it, and I feel an attack of
                    the vapors coming on that makes me wonder if I'll
                    be able to keep the server up, I'll
                    DM <a href="https://en.wikipedia.org/wiki/Jason_Scott">Jason
                      Scott</a>, which is something I often do,
                    actually, and I'll ask him to tell me exactly what
                    to do to archive the data here without violating
                    anyone's privacy. </p>

                  <h2>There's no business model.</h2>
                  
                  <p>There are tons of business models and
                    not-business models. Right now it has one user and
                    this thing would need to get many thousands of
                    committed daily users before it cost more than a
                    couple hundred bucks to run per month. Let's see
                    what happens.</p>
                  
                  <h2>That has nothing to do with the blockchain.</h2>
                  
                  <p>It would be nice, some day, to auto-publish
                    Timeline hashes into a blockchain so that people
                    can be relatively assured that history has not
                    been manipulated. Or to reward successful data
                  ...
                  <p>Maybe! I don't really want to own time or culture
                    though. I want people to feel safe and protected
                    and like they have the tools they need to do good
                    work. It is nice to imagine a federated service,
                    used to index HTML microformats, blog posts, and
                    tweets at the time of their authorship. On the
                    other hand, humans love convenience so maybe a
                    centralized service is best. This thing only has
                    one user so it doesn't really matter. Let's see
                    what happens.</p>

                  <h2>The approach to date-time parsing and processing is utterly half-assed.</h2>
                  
                  <p>Yes, it's terrible. Extracting a date from, say,
                    a filename on archive.org and turning it into a
                    realistic calendar moment is pretty hard. There's
                    a lot to learn here. Frankly you could be looking
                    at a clay pot from Sicily that's circa 1500 and
                    not know whether it's circa 1500 Greenwich Mean
                    Time or circa 1500 Eastern Standard
                    Daylight. Anwyway right now I'm winging it and
                    just pretending timezones aren't real. Let's see
                    what happens.</p>
                  ...
                  <p>Yes, agreed. It's a writing tool that keeps the
                    vaguest chronology in view. Let's see what happens.</p>

                  <h2>The events show all kinds of bias.</h2>
                  
                  <p>They sure do. The resources in the commons that
                    I'm importing are definitely biased towards the
                    conventionally-funded western-dominated metric of
                    what's important. There's only so much I
                    personally can do here, so I'll pay a reasonable
                    hourly rate for people who want to correct that
                    and create timelines around marginalized people's
                    history. If you know someone who should do that
                    kind of work ping me and I'll reach out to
                    them. Let's see what happens.</p>
                  
                  <h2>How will I know if the events are accurate?</h2>
                  
                  <p>Oh sheesh have I thought hard about this
                    one. This sounds simple but it actually veers into
                  ...
                  <p>Even when you import really well-regarded
                    sources--museum collections, for example--it's
                    hard to know when something happened and often
                    utterly ambiguous. Dealing with that ambiguity led
                    me to come up with the "principle of the last
                    possible moment."  For example if something is
                    identified as being "circa 1880-1889" the
                    datestamp I assign to it is December 31st 1889 one
                    second before midnight. Let's see what
                    happens. This is because the problem I've found
                    when writing about things that happened is almost
                    always that you put them too soon, not too
                  ...
                  <p>Here's a hedge for you: A community, should one
                    form, will define the culture here, and the
                    software would support the community's definition
                    of accuracy. Let's see what happens.</p>
                  ...
                  <p>Anyway if this thing looks like it's being used
                    to harm people I'll boot people or pull the
                    plug. I have to do enough bullshit in my life to
                    keep all the fires lit. I'm not going to have my
                    side project become yet another Internet tool for
                    dehumanization.</p>

                  <p>Plus it gets more complex. Archives are totally
                    biased in favor of history, news, fame, and
                    money. Because that's who makes archives. Doing
                    this project has made that ridiculously
                    obvious. Public data in the commons is either
                    about vast, anonymized groups of people (like
                    ...
                    has its own tractable history now, running 25
                    years, with lots of voices represented. But for
                    the most part the public archives that I'm
                    importing don't represent regular people very
                    much. The Cooper Hewitt Design Museum does pretty
                    well because everyone needs wallpaper.</p>
